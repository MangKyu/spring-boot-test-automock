package com.mangkyu.springboot.test.automock.config;

import com.mangkyu.springboot.test.automock.beanfactorypostprocessor.AutoMockBeanFactoryPostProcessor;
...
@ConditionalOnProperty(name = "com.mangkyu.springboot.test.automock", havingValue = "true")
